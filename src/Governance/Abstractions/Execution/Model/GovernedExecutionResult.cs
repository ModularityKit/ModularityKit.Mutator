...
/// <summary>
/// Captures the outcome of executing governed mutation request.
/// </summary>
public sealed record GovernedExecutionResult<TState>
{
    ...
    /// <summary>
    /// Classifies the execution path represented by this result.
    /// </summary>
    public GovernedExecutionKind ExecutionKind { get; init; } = GovernedExecutionKind.Standard;

    /// <summary>
    /// Compensation plan attached to the execution when the request is compensating.
    /// </summary>
